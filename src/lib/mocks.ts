...
export const books: Book[] = [
  ...
  },
  {
    id: 12,
    authorId: "f3f55fa8-0e55-428e-8e13-15de0184795c",
    reviewIds: ["test0", "test1"],
    name: "О мышах и людях",
    description:
      " повесть Джона Стейнбека, опубликованная в 1937 году, рассказывающая трагическую историю двух сезонных рабочих во время Великой депрессии в Калифорнии и касающаяся таких понятий, как мечта, вина и сочувствие. Книга основана на личном опыте Стейнбека, работавшего в сельском хозяйстве в 1920-е годы"
  }
];
...
export const reviews: Review[] = [
  {
    userId: "test",
    id: "test0",
    text: "отличная повесть"
  },
  {
    userId: "test",
    id: "test1",
    text: "Даже лучше чем Гроздья гнева"
  },
  {
